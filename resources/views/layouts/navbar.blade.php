<nav class="navbar navbar-expand navbar-light navbar-bg">
    ...
    <div class="navbar-collapse collapse">
        <ul class="navbar-nav">
            <h4 class="my-auto" style="text-align: center; font-weight: bold;">Sistem Peminjaman Barang BAAK</h4>
            <li class="nav-item dropdown">
                <h4 class="ml-2 fw-bold mt-2">{{ auth()->user()->nama }}</h4>
            </li>
        </ul>
        <ul class="navbar-nav navbar-align">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
                    ...
                    <div class="list-group">
                        <a href="#" class="list-group-item">
                            <div class="row g-0 align-items-center">
                                <div class="col-2">
                                    <img src="{{ asset('images/avatar.png') }}" class="avatar img-fluid rounded-circle"
                                        alt="Vanessa Tucker">
                                </div>
            ...
            <li class="nav-item dropdown">
                ...
                @else
                    <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="{{ route('peminjam.userprofile') }}"><i
